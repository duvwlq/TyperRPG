...
|-------|------|----------|-------|------|
| **Phase 1** | Day 1-3 | 프론트엔드 마무리 및 배포 | 95% | 🚧 진행 중 |
| **Phase 2** | Day 4-6 | Spring Boot 기본 설정 | 5% | ❌ 대기 |
| **Phase 3** | Day 7-9 | 데이터베이스 및 엔티티 구현 | 0% | ❌ 대기 |
| **Phase 4** | Day 10-12 | 백엔드 서비스 및 API 구현 | 0% | ❌ 대기 |
| **Phase 5** | Day 13-15 | 프론트엔드-백엔드 연동 | 0% | ❌ 대기 |
...
- [ ] GameScoreService & Controller
- [ ] ShopService & Controller
